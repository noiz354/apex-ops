...
export const workOrders = pgTable(
  'work_orders',
  {
    ...
    description: text('description'), // BR-02: scope text from work-orders/new
    lotoRequired: boolean('loto_required').notNull().default(false), // BR-02
    createdAt: timestamp('created_at', { withTimezone: true }).notNull().defaultNow(),
...
export const subscriptions = pgTable(
  'subscriptions',
  {
    ...
    plan: text('plan').notNull().default('COMMUNITY'), // COMMUNITY | GROWTH | ENTERPRISE (BR-14 fail-closed default)
